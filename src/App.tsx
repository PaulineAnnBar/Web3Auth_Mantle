...
const clientId =
  "BA5h3a4P2JKVkEe7MA-mgNfsoB9sjjvW7gLPEgAjK9ViG9Y__51XyDwl9jjgmIjEnl_dLSy6r4Man59KXfbRJsk"; // get from https://dashboard.web3auth.io
// IMP END - Dashboard Registration

const chainConfig = {
  chainId: "0x1388", 
  rpcTarget: "https://rpc.mantle.xyz",
  // Should we use ankr or quicknode?
